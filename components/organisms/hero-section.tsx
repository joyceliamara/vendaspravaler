...
export function HeroSection() {
  ...
  return (
    <section className="bg-hero-mobile md:bg-hero bg-cover bg-no-repeat  w-full h-full min-h-[83vh] flex flex-col items-center relative overflow-hidden pb-10 md:pb-16">
      <div className="w-full flex justify-center bg-destructive text-white text-center py-2">
      ...
      <div className="container px-4 md:px-6 relative z-10 mt-52 md:mt-36">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 items-start justify-start">
          ...
          <div className="space-y-8 relative z-20">
            ...
            <h1 className=" flex flex-col gap-3 text-2xl md:text-5xl lg:text-4xl tracking-tight relative z-10">
              <span>
            ...
            <div className="flex sm:flex-row justify-center relative z-10">
              <CTAButton
                type="submit"
